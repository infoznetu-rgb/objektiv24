const CACHE='objektiv24-pwa-v22';
const CORE=['/','/index.html','/styles.css','/app.js','/clanok.html','/clanok.js','/pwa.js','/analytics.js','/image-meta-public.js','/ako-pracujeme.html','/kontakt.html','/kontakt-odoslane.html','/manifest.webmanifest','/app-launch.js','/assets/app-mark-modern.svg','/assets/app-icon.svg','/assets/app-icon-192.svg','/assets/app-icon-512.svg','/assets/app-icon-maskable-512.svg'];
