...
loadArticles();
(()=>{let a=document.createElement('script');a.src='analytics.js?v=4';a.onload=()=>{let p=document.createElement('script');p.src='pwa.js?v=5';p.defer=true;document.head.appendChild(p)};document.head.appendChild(a)})();
