...
function articleHtml(a,related=[],nextArticle=null,guides=[]){
  ...
  const correctionBlock = a.correctionNote ? `<section class="article-correction" aria-label="Oprava článku"><span>OPRAVA${a.correctedAt?` · ${esc(displayDate(a.correctedAt))}`:""}</span><p>${esc(a.correctionNote)}</p></section>` : "";
...
<head>
  ...
  <link rel="stylesheet" href="/styles.css?v=20260920-legal1">
...
<body>
  ...
  <main id="obsah" class="article-page">
    <article class="article-detail container">
      ...
      ${briefBlock}
      ${a.image ? `<figure class="article-detail-image" style="margin-inline:auto;width:100%;max-width:1200px;overflow:hidden;border-radius:24px;background:#08131a"><img src="${esc(a.image)}" alt="${esc(a.imageAlt)}"${responsiveImageAttrs(a.image,"(max-width:800px) 100vw, 1200px")} loading="lazy" decoding="async" style="display:block;width:100%;height:auto;max-height:none;object-fit:contain;object-position:center;background:#08131a"><figcaption>${esc(imageMeta)}${a.imageSource ? ` · <a href="${esc(a.imageSource)}" rel="noopener noreferrer">zdroj ↗</a>` : ""}</figcaption></figure>` : ""}
      <div class="article-detail-grid">
        ...
        <aside class="article-detail-side">
          ...
          <div class="article-side-card"><span class="eyebrow">ZODPOVEDNOSŤ</span><strong>Objektív24.sk</strong><p>Redakčná zodpovednosť za zverejnenie. Žiadosti o uverejnenie opravy posielajte na <a href="mailto:objektiv24.opravy@gmail.com">objektiv24.opravy@gmail.com</a>. Ďalšie podrobnosti sú na stránke <a href="/pravne-informacie.html">Právne informácie</a>.</p></div><div class="article-side-card"><span class="eyebrow">ZDROJE</span><p>Pri praktických a časovo citlivých témach uvádzame použité podklady priamo v článku.</p></div>
        </aside>
      </div>
      ${guideBlock}
      ${relatedBlock}
  ...
  <footer class="site-footer"><div class="container footer-grid"><div><a class="brand" href="/"><span class="brand-word">OBJEKTÍV</span><span class="brand-badge">24</span></a><p>Čo sa deje. Čo to znamená pre vás. Čo ďalej.</p></div><div class="footer-links"><a href="/odber/" data-track-event="audience_hub_click">Odoberať</a><a href="/clanky/">Všetky články</a><a href="/ako-pracujeme.html">Ako pracujeme</a><a href="/kontakt.html">Kontakt</a><a href="/pravne-informacie.html">Právne informácie</a><a href="mailto:objektiv24.opravy@gmail.com">Opravy</a></div><p class="copyright">© 2026 Objektív24 · Prevádzkovateľ: Jozef Kameník · fyzická osoba – nepodnikateľ. Nie sme štátny úrad ani jeho oficiálny partner.</p></div></footer>
</body>
</html>`;
}
...
async function fetchDbArticles(){
  ...
  const select="id,title,seo_title,meta_description,category,intro,what_happened,what_it_means,next_step,sources,image_url,image_type,image_alt,image_source_url,image_credit,image_license,image_position,slug,published_at,verified_at,updated_at,correction_note,corrected_at";
...
const sitemapUrls=[
  ...
  {loc:SITE+"/pravne-informacie.html"},
